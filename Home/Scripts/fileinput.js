...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            '    <div class="close fileinput-remove"><span class="fa fa-times-circle"></span></div>\n' +
            '    <div class="{dropClass}">\n' +
            ...
            '    </div>\n' +
            '</div>',
        tIcon = '<span class="fa fa-file-image-o kv-caption-icon fa-green"></span> &nbsp;',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIcon: '<i class="fa fa-photo-o"></i>',
