...
namespace Home.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private Home.DAL.HomeContext db = new DAL.HomeContext();
        ...
        public ActionResult RetrieveImage(string id)
        {
            ...
            Response.Cookies["userId"].Value = currentUser.Id;
            ...
            {
                var src = @"\images\empty_user.jpg";
                return File(src, "image/jpg");
            }
        }
        [OutputCache(Duration = int.MaxValue,Location = OutputCacheLocation.Client, VaryByParam = "image")]
        ...
        public byte[] GetImageFromDataBase(string Id)
        {
            ...
            var q = from temp in db.userPics where temp.Userid == Id select temp.image;
            if (q.ToList().Count > 0)
                cover = q.First();
            return cover;
        }
